...
public enum Localization {
    ...
    public TextComponent getMessage(OfflinePlayer player) {
        if (hasPlaceholders){
    ...
    public TextComponent getMessage(OfflinePlayer player, String... replace){
        if (hasPlaceholders){
            return (TextComponent) LocalizationLoader.parser.deserialize(LocalizationLoader.placeholderManager.usePlaceholders(player, def), generateTagResolver(replace));
        }
        return (TextComponent) LocalizationLoader.parser.deserialize(def, generateTagResolver(replace));
    }
    ...
    private void setMessage(TextComponent message) {
